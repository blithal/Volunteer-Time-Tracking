...
class _ViewUsersPage extends State<ViewUsersPage> {
  ...
  List<DataColumn> _createColumns() {
    return [
      ...
      DataColumn(
        label: const Text('First Name', textAlign: TextAlign.center),
      ...
      DataColumn(
        label: const Text('Last Name', textAlign: TextAlign.center),
        onSort: (columnIndex, _) {
          setState(() {
            _currentSortColumn = columnIndex;
            if (_isSortAsc) {
      ...
      DataColumn(
        label: const Text('Email', textAlign: TextAlign.center),
        onSort: (columnIndex, _) {
          setState(() {
            _currentSortColumn = columnIndex;
            if (_isSortAsc) {
      ...
      DataColumn(
        label: const Text('Phone Number', textAlign: TextAlign.center),
        onSort: (columnIndex, _) {
          setState(() {
            _currentSortColumn = columnIndex;
            if (_isSortAsc) {
